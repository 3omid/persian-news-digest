...
# ---------------------------------------------------------------
# ۲.۵) شعر روزانه - لیست دستچین‌شده و تایید‌شده (نه تولید LLM)
# ---------------------------------------------------------------
# چرا از LLM گرفته نمی‌شه: باگی که کاربر گزارش داد این بود که بخش «شعر» بین اجراهای
# ساعتی مختلف، برخلاف tip/quiz/quote، عملا هیچ‌وقت عوض نمی‌شد - با اینکه از مدل خواسته
# می‌شد شعر «تازه» تولید کنه، تقریبا همیشه به همون یکی-دو بیت مشهورترین (که مطمئن‌تر
# بهش بود) برمی‌گشت. راه‌حل: یک لیست ثابت و تاییدشده از ابیات معروف شش شاعر کلاسیک
# فارسی که analyze._pick_poem با پرهیز از تکرار اخیر (fetch_news.get_recent_extras)
# ازش چرخشی انتخاب می‌کنه - هم واقعا متنوعه، هم خطر نسبت‌دادن اشتباه بیت به شاعر غلط
# رو از بین می‌بره. هر آیتم یک بیت کامل (دو مصرع) با نام شاعره.
FAMOUS_PERSIAN_POEMS = [
    {"lines": ["بنی آدم اعضای یک پیکرند", "که در آفرینش ز یک گوهرند"], "poet": "سعدی"},
    {"lines": ["تن آدمی شریف است به جان آدمیت", "نه همین لباس زیباست نشان آدمیت"], "poet": "سعدی"},
    {"lines": ["به جهان خرم از آنم که جهان خرم از اوست", "عاشقم بر همه عالم که همه عالم از اوست"], "poet": "سعدی"},
    {"lines": ["یوسف گم گشته باز آید به کنعان غم مخور", "کلبه احزان شود روزی گلستان غم مخور"], "poet": "حافظ"},
    {"lines": ["دلا بسوز که سوز تو کارها بکند", "نیاز نیم‌شبی دفع صد بلا بکند"], "poet": "حافظ"},
    {"lines": ["بیا تا گل برافشانیم و می در ساغر اندازیم", "فلک را سقف بشکافیم و طرحی نو دراندازیم"], "poet": "حافظ"},
    {"lines": ["ز دست دیده و دل هر دو فریاد", "که هر چه دیده بیند دل کند یاد"], "poet": "حافظ"},
    {"lines": ["بشنو از نی چون حکایت می‌کند", "از جدایی‌ها شکایت می‌کند"], "poet": "مولانا"},
    {"lines": ["هر کسی کو دور ماند از اصل خویش", "باز جوید روزگار وصل خویش"], "poet": "مولانا"},
    {"lines": ["از محبت خارها گل می‌شود", "وز محبت سرکه‌ها مل می‌شود"], "poet": "مولانا"},
    {"lines": ["توانا بود هر که دانا بود", "ز دانش دل پیر برنا بود"], "poet": "فردوسی"},
    {"lines": ["بسی رنج بردم در این سال سی", "عجم زنده کردم بدین پارسی"], "poet": "فردوسی"},
    {"lines": ["میازار موری که دانه‌کش است", "که جان دارد و جان شیرین خوش است"], "poet": "فردوسی"},
    {"lines": ["ای دوست بیا تا غم فردا نخوریم", "وین یکدم عمر را غنیمت شمریم"], "poet": "خیام"},
    {"lines": ["یک چند به کودکی به استاد شدیم", "یک چند به استادی خود شاد شدیم"], "poet": "خیام"},
    {"lines": ["این قافله عمر عجب می‌گذرد", "دریاب دمی که با طرب می‌گذرد"], "poet": "خیام"},
    {"lines": ["از دی که گذشت هیچ از او یاد مکن", "فردا که نیامده است فریاد مکن"], "poet": "خیام"},
    {"lines": ["هر که را اسرار حق آموختند", "مهر کردند و دهانش دوختند"], "poet": "عطار"},
]
